...
public class PurchaseOrderImpl implements IPurchaseOrder {
	...
	public String purchase(String[] items, double[] price, String[] emails) throws Exception {
		double billAmt=0.0;
		for(double p:price) billAmt=billAmt+p;
		String msg=Arrays.toString(items)+" with prices"+Arrays.toString(price)+" are purchased with BillAmount "+billAmt;
	...
	public String sendMail(String msg, String[] toEmails) throws Exception {
		...
		helper.setText(msg);
		helper.addAttachment("Krishna.png",new ClassPathResource("Krishna.png"));
		sender.send(message);
		return "mail sent";
	}
